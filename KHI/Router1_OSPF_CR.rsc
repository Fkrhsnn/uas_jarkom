...
add address=10.0.1.1/30 interface=tunnel2 network=10.0.1.0

/routing ospf network
add area=backbone comment="GRE Tunnel to Router 2" network=10.0.0.0/30
add area=backbone comment="GRE Tunnel to Router 3" network=10.0.1.0/30
