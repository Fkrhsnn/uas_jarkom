...
/interface gre
add name=tunnel2 local-address=192.168.0.6 remote-address=192.168.0.1
add name=tunnel3 local-address=192.168.0.6 remote-address=192.168.0.5
...
/routing ospf network
add area=backbone comment="Tunnel ke Router 1" network=10.0.0.4/30
add area=backbone comment="Tunnel ke Router 2" network=10.0.0.8/30
